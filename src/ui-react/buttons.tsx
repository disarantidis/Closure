...
// Leads the collections card's own title — a braces glyph, the common
// "variable/token" mark in developer tooling (this plugin exports
// Figma *variables* as tokens, so it reads correctly here specifically,
// not just as a generic decoration). Replaces the right-chevron this
// card briefly carried as an "opens a modal" affordance — asked to be
// removed since this card isn't an accordion and doesn't need to
// borrow that vocabulary; the card's own hover/press states (a real
// InteractiveCard, not a hand-rolled clickable div) already carry that.
const IconVariables = svg('M8 3H7a2 2 0 0 0-2 2v5a2 2 0 0 1-2 2 2 2 0 0 1 2 2v5c0 1.1.9 2 2 2h1 M16 21h1a2 2 0 0 0 2-2v-5c0-1.1.9-2 2-2a2 2 0 0 1-2-2V5a2 2 0 0 0-2-2h-1');
